...
from backend.models.datahub.core import DataHubSource, DataHubRecord, AuditLog, DuplicateGroup, Patient, Visit, MedicalRecord
...
@router.get("/summary")
def get_summary(db: Session = Depends(get_datahub_session)):
    """
...
def get_summary_detailed(db: Session = Depends(get_datahub_session)):
    """
...
def get_duplicate_statistics(db: Session = Depends(get_datahub_session)):
    """
