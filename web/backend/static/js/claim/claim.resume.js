...
(function() {
        ...
        html += `
            ...
            ">
                ...
                <div style="font-size: 12px; color: #059669;">
                    Generated automatically by AI Claim Core | Version 2025.10 | ${new Date().toLocaleDateString('id-ID')}
                </div>
            </div>
        `;
    ...
    function buildCleanResumeText(data) {
        ...
        text += `${'='.repeat(80)}\n`;
        text += `Generated automatically by AI Claim Core | Version 2025.10 - ${new Date().toLocaleString()}`;
