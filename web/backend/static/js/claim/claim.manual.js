...
(function () {
  function addManual(type, tab) {
    ...
    // kalau daily → update ringkasan daily
    ...
    // ✅ enrichment ke core_engine.analyze_diagnosis
